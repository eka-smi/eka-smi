...
- **SQL**
- ML: supervised/unsupervised learning, regression/classification, decision trees, ensemble methods
- DL: MLP/CNN/RNN (seq2seq), regularization, stable training basics, autoencoders / generative models
- Scientific computing: Wolfram Mathematica, MATLAB
- Writing & docs: LaTeX
